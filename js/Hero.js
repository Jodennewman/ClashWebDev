...
console.log('Hero.ts loaded');
function initHero() {
    const container = document.getElementById("pixi-container-hero");
    if (!container) {
    ...
    return (() => __awaiter(this, void 0, void 0, function* () {
        ...
        (_a = document.getElementById("pixi-container-hero")) === null || _a === void 0 ? void 0 : _a.appendChild(app.canvas);
        // ==================================
        // 2) LOAD ASSETS
        // ==================================
        yield pixi_js_1.Assets.load([
        ...
        // ==================================
        const pipeContainer = new pixi_js_1.Container();
        ...
        const pipeSprite = pixi_js_1.Sprite.from('/assets/main/simplePipe.webp');
        pipeContainer.addChild(pipeSprite);
        const pipeSpriteTop = pixi_js_1.Sprite.from('/assets/main/simplePipeTop.webp');
        ...
        // Displacement sprite
        const displacementSprite = pixi_js_1.Sprite.from('/assets/main/PipeDispMap.webp');
        ...
        // Displacement filter
        const displacementFilter = new pixi_js_1.DisplacementFilter(displacementSprite);
        ...
        // ==================================
        const pipeMiddleContainer = new pixi_js_1.Container();
        ...
        function spawnEyeball() {
            const eyeballContainer = new pixi_js_1.Container();
            // 1) Random eyeball sprite
            const randomIndex = Math.floor(Math.random() * 6) + 1;
            const newRandom = randomIndex === 4 ? 5 : randomIndex;
            const eyeballSprite = pixi_js_1.Sprite.from(`/assets/main/eyeballSprite${newRandom}.webp`);
            ...
            const eyeDispSprite = pixi_js_1.Sprite.from('/assets/main/PipeDispMap.webp');
            eyeDispSprite.texture.source.addressMode = 'clamp-to-edge';
            eyeDispSprite.anchor.set(-0.05);
            const eyeDispFilter = new pixi_js_1.DisplacementFilter(eyeDispSprite);
        ...
        function spawnMultipleEyeballs(count, startX, startY) {
            for (let i = 0; i < count; i++) {
                ...
                let tween = animation_service_1.gsap.to(eContainer, {
                    alpha: 1,
                    motionPath: {
                ...
                let tween2 = animation_service_1.gsap.to(eContainer.children, {
                    rotation: (Math.random() - 0.5) > 0 ? 7 : -7,
                    duration: 1.2,
                    delay: delayAmount,
                    ease: "power3.out",
                });
                let tweenScale = animation_service_1.gsap.to(eContainer.scale, {
                    x: 1,
                    y: 1,
                    duration: 0.2,
                    delay: delayAmount,
                ...
                let yoyoScale = animation_service_1.gsap.to(eContainer.scale, {
                    x: 1.4,
                    y: 1.4,
        ...
        function spawnMainEyeball(startX, startY) {
            ...
            let tween = animation_service_1.gsap.to(mainEyeContainer, {
                alpha: 1,
                motionPath: {
            ...
            let tween2 = animation_service_1.gsap.to(mainEyeContainer.scale, {
                x: 1,
                y: 1,
                duration: 0.5,
                ease: "power3.in"
            });
            let tween3 = animation_service_1.gsap.to(mainEyeContainer, {
                y: "+=700",
                x: "-=200",
                duration: 1,
                ease: "power3.in",
            });
            let yoyoScale = animation_service_1.gsap.to(mainEyeContainer.scale, {
                x: 1.4,
                y: 1.4,
                ease: "slow(0.4, 0.55, true)",
                duration: 0.8,
            });
            let tweenRotate = animation_service_1.gsap.to(mainEyeContainer.children, {
                rotation: 12,
                duration: 1.5,
                ease: "power3.out",
            });
        ...
        const mainTL = animation_service_1.gsap.timeline({
            scrollTrigger: {
                trigger: "#heroSection",
                ...
                markers: true,
                id: "heroPin",
                onEnter: () => console.log("Hero section entered view"),
            }
        });
        console.log("ScrollTrigger is:", gsap_setup_1.ScrollTrigger);
        ...
        function animateDesignGrid(direction = "away") {
            ...
            if (direction === "away") {
                animation_service_1.gsap.to(designGrid, {
                    y: "150vh",
                    x: "10vw",
                    scale: 0.8,
                    opacity: 0,
